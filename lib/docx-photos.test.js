...
const drawing = (rel, descr, cx = 5486400, cy = 3657600) => `<w:p><w:r><w:drawing>
...
${drawing("rIdProp", "An aerial view of a building and parking lot  AI-generated content may be incorrect.")}
...
test("replacing one photo changes that image and that drawing, and nothing else", async () => {
  ...
  assert.ok(doc.startsWith(DOCUMENT.slice(0, DOCUMENT.indexOf("<w:drawing>", DOCUMENT.indexOf("692BE70D")))));
