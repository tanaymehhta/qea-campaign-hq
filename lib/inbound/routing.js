...
const TLD = {
  ...
  om: "OM", il: "IL", tr: "TR", mx: "MX", ca: "CA", uk: "GB", gb: "GB", ie: "IE", ph: "PH",
...
export const REPS = [
  ...
  { id: "gul-reyes", name: "Gul Reyes", initials: "GR", tint: "var(--tint-2)",
    regions: ["ASIA", "AE"], role: "Asia · UAE" },
  { id: "mark-dolan", name: "Mark Dolan", initials: "MD", tint: "var(--tint-3)",
    regions: ["CA"], role: "Canada" },
  { id: "mark-wasu", name: "Mark Wasu", initials: "MW", tint: "var(--tint-4)",
